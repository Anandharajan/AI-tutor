...
def main():
    st.set_page_config(page_title="AI Tutor 📚🤖", page_icon="AI_Tutor/assets/The Crest Logo.png")
    ...
    query = st.text_input("Ask a question or specify a topic to learn", placeholder="Type your question or topic here...")
    if query:
